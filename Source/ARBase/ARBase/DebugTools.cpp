...
void EnableCategory(int32 category, bool enabled)
{
	auto& data = FindCategoryData(category);
	data.Enabled = enabled;
}

void ToggleCategory(int32 category)
{
	auto& data = FindCategoryData(category);
...
void DrawText(int32 category, NotNullPtr<UWorld> world, const FString& msg, const FColor& color,
			  float lifetime)
{
...
void DrawBox(int32 category, NotNullPtr<UWorld> world, const FVector& center,
...
void DrawCylinder(int32 category, NotNullPtr<UWorld> world, const FVector& start,
...
void DrawDirectionalArrow(int32 category, NotNullPtr<UWorld> world, const FVector& start,
...
void DrawSphere(int32 category, NotNullPtr<UWorld> world, const FVector& center, float radius,
				float segments, const FColor& color, float thickness, float lifetime)
{
	if (!IsCategoryEnabled(category))
	{
		return;
													 ...
													 int line)
{
	...
	delegate.BindLambda([category]() { ToggleCategory(category); });
